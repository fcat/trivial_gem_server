Gem::Specification.new do |spec|
  spec.name = "rack-protection"
  spec.version = "1.5.0"
  spec.platform = "ruby"
  spec.date = "2013-03-13"
  spec.summary = "You should use protection!"
  spec.description = "You should use protection!"
  spec.authors = ["Konstantin Haase", "Alex Rodionov", "Chris Heald", "Chris Mytton", "Corey Ward", "David Kellum", "Egor Homakov", "Florian Gilcher", "Fojas", "Mael Clerambault", "Martin Mauch", "SAKAI, Kazuaki", "Stanislav Savulchik", "Steve Agalloco", "Akzhan Abdulin", "TOBY", "Bjørge Næss"]
